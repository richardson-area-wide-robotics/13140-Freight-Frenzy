...
@Autonomous(name = "AT_B1_CS_16", group = "Linear Opmode")
public class AT_B1_CS_16 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gyDrive(18, flex, 315, 1);
        tiDiagonal(1, taut, 1, 0, 1);
        carousel(12, .1, -1);
        gyDrive(22,flex,270,1);
        tiDiagonal(1, flex,1,1,1);
