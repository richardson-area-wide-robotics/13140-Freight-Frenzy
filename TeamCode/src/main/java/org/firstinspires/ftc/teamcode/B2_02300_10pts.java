...
@Autonomous(name="B2_02300_10pts", group="Linear Opmode")  // @TeleOp(...) is the other common choice

// Start robot with right side against wall & front against tile

public class B2_02300_10pts extends LinearOpMode {
